...
for i_s = 1:n_s % run through samples
    ...
    if sel(i_s) == 1 % for SD
        ...
        ind_mw = find(strcmp(names_lim,'mw')==1); % find location of <mw> in <pmat_lim>
        ind_bw = find(strcmp(names_lim,'bw')==1); % find location of <bw> in <pmat_lim>
...
%         plot(i_s,mwbw_all(1),'ko','MarkerFaceColor','y')
    ...
    elseif sel(i_s) == 2 % for IT
        ...
        ind_Fs   = find(strcmp(names_lim,'Fs')==1); % find location of <Fs> in <pmat_lim>
