...
opt_ecx.rob_rng   = [0.5 300 300 1]; % range for calculation of robust EPx, nr points, and log (0) or normal scale (1)
opt_ecx.rob_cust  = [0.1:0.1:20 21:1:99 100:5:300]'; % custom range for ERA purposes (smaller steps in interesting region)
